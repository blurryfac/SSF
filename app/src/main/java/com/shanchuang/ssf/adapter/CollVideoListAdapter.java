 ...
 * @time 2019/10/24
 */
public class CollVideoListAdapter extends BaseQuickAdapter<VideoListBean.CourseBean, BaseViewHolder> {
    public CollVideoListAdapter(int layoutResId, @Nullable List<VideoListBean.CourseBean> data) {
