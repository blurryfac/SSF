...
import com.shanchuang.ssf.citypicker.util.GetJsonDataUtil;
import com.shanchuang.ssf.net.entity.JsonBean;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_LOAD_FAILED:
                    Toast.makeText(mContext, "解析城市文件出错", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    private String tx;
    public PickerView2(Context mContext) {
        this.mContext = mContext;
    }

    public String showPickerView(Activity activity, final TextView tv) {// 弹出选择器
