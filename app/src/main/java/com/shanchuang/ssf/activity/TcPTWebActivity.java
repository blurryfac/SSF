 ...
 * @time 2019/11/26
 */
public class TcPTWebActivity extends BaseActivity {
    /**
     * 调用支付宝
     */
    ...
    Toolbar toolbar;
    @BindView(R.id.tv_contact_pt)
    TextView tvContactPt;
    private String url = "";
    ...
    protected int getLayoutId() {
        return R.layout.activity_tc_pt_web_layout;
    }
    ...
    protected void initView() {
        ...
        tvContactPt.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        web.addJavascriptInterface(new Contact() {
            ...
            public void callAndroid(String YYWh5, String file) {
                ...
                switch (YYWh5) {
                    ...
                    case "gaode1"://调起高德地图
                        loc = YYWh5.split(",");
                        boolean b = isPackageInstalled(TcPTWebActivity.this, "com.autonavi.minimap");
                        if (b) {
                            ...
                            TcPTWebActivity.this.startActivity(naviIntent);
                        } else {
    ...
    private void showShareDialog(final int thumb_img, String file) {
        tcDialog = DialogUtil.getInstance().showShareDialog(TcPTWebActivity.this);
        DialogUtil.getInstance().setOnShareClickListener(new DialogUtil.OnShareClickListener() {
            @Override
            public void qqOnClick(View v) {
                DialogUtil.ShareWeb(thumb_img, SHARE_MEDIA.QQ, TcPTWebActivity.this, HttpMethods.SHARE_TITLE, HttpMethods.SHARE_DESC, HttpMethods.SHARE_URL + file);
            }

            @Override
            public void circleOnClick(View v) {
                DialogUtil.ShareWeb(thumb_img, SHARE_MEDIA.WEIXIN_CIRCLE, TcPTWebActivity.this, HttpMethods.SHARE_TITLE, HttpMethods.SHARE_DESC, HttpMethods.SHARE_URL + file);
            }

            @Override
            public void qZoneOnClick(View v) {
                DialogUtil.ShareWeb(thumb_img, SHARE_MEDIA.QZONE, TcPTWebActivity.this, HttpMethods.SHARE_TITLE, HttpMethods.SHARE_DESC, HttpMethods.SHARE_URL + file);
            }

            @Override
            public void weixinOnClick(View v) {
                DialogUtil.ShareWeb(thumb_img, SHARE_MEDIA.WEIXIN, TcPTWebActivity.this, HttpMethods.SHARE_TITLE, HttpMethods.SHARE_DESC, HttpMethods.SHARE_URL + file);
            }
        });
        tcDialog.show();
    }
    ...
    private void showPayDialog() {
        tcDialog = DialogUtil.getInstance().showPayDialog(TcPTWebActivity.this);
...
//                    mHandler.sendEmptyMessage(0x10);
         ...
         * 第二个参数:压缩后视频保存的路径
         */
//                    path = SiliCompressor.with(TcPTWebActivity.this).compressVideo(selectList.get(0).getPath(), Environment.getExternalStorageDirectory().getPath());
//                    uploadVideo();
//                    Log.i("-------------", path);
...
//        HttpMethods.getInstance().uploadFile(new ProgressSubscriber<>(onNextListener, this, true), params);
    ...
    static class MyHandler extends Handler {
        ...
        WeakReference<TcPTWebActivity> mActivity;

        MyHandler(TcPTWebActivity activity) {
            mActivity = new WeakReference<TcPTWebActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            TcPTWebActivity theActivity = mActivity.get();
            switch (msg.what) {
                case 0x10:
