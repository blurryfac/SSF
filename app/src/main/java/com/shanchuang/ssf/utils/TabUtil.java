...
/**
 * tablayout跟随字体长度显示下标
 * Created by JY on 2018/4/13.
 */

public class TabUtil {
    private static class SingletonHolder {
        private static final TabUtil INSTANCE = new TabUtil();
    }
            ...
            public void run() {
                try {
                    ...
                    for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                        ...
                        Field mTextViewField = tabView.getClass().getDeclaredField("textView");//sdk28之后带M的全被砍掉
